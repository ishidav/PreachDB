...
%
transition(State) ->
        T = [ send_req_s(State,1), send_req_s(State,2), 
              send_req_e(State,1), send_req_e(State,2),
              recv_req_s(State,1), recv_req_s(State,2),
              recv_req_e(State,1), recv_req_e(State,2),
              send_inv(State,1), send_inv(State,2),
              send_inv_ack(State,1), send_inv_ack(State,2), 
              recv_inv_ack(State,1), recv_inv_ack(State,2), 
              send_gnt_s(State,1), send_gnt_s(State,2),
              send_gnt_e(State,1), send_gnt_e(State,2),
