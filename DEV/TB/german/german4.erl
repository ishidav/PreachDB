...
ms_undefined() -> #ms{
   ...
   curCmd = undefined,
   exGntd = undefined,
   shrSet = {undefined,undefined,undefined,undefined},
   invSet = {undefined,undefined,undefined,undefined},
   chan3 = {mSG_undefined(),mSG_undefined(),mSG_undefined(),mSG_undefined()},
   chan2 = {mSG_undefined(),mSG_undefined(),mSG_undefined(),mSG_undefined()},
   chan1 = {mSG_undefined(),mSG_undefined(),mSG_undefined(),mSG_undefined()},
   cache = {cACHE_undefined(),cACHE_undefined(),cACHE_undefined(),cACHE_undefined()}
}.
...
init(MS_0 = #ms{},D) ->
      MS_1 = forloop(MS_0,1,4,fun(I,MS_0_0=#ms{}) ->
...
sendGntE_guard(MS_0 = #ms{},I) ->
   (((((((((MS_0#ms.curCmd) == (reqE)) and ((MS_0#ms.curPtr) == (I)))) and ((((element(I,MS_0#ms.chan2))#mSG.cmd)) == (empty)))) and ((MS_0#ms.exGntd) == (false)))) and (forall(lists:seq(1,4), fun(J) -> ((element(J,MS_0#ms.shrSet))) == (false) end)))
.
...
recvReqE(MS_0 = #ms{},I) ->
   ...
   if (G) ->
      ...
      MS_4 = forloop(MS_3,1,4,fun(J,MS_3_0=#ms{}) ->
